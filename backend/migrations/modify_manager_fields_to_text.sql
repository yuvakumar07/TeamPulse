-- Modify offshore_manager_id and onsite_manager_id to VARCHAR fields
...
ALTER TABLE employees
  MODIFY COLUMN offshore_manager_id VARCHAR(255) NULL,
  MODIFY COLUMN onsite_manager_id VARCHAR(255) NULL;
